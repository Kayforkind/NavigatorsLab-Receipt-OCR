...
> Read totals off receipt photos, export for expenses

![License](https://img.shields.io/badge/license-MIT-blue) ![Privacy](https://img.shields.io/badge/privacy-no%20uploads-black) ![Offline](https://img.shields.io/badge/offline-first-8b5cf6) ![PRs](https://img.shields.io/badge/PRs-welcome-green) ![Pages](https://img.shields.io/github/deployments/Kayforkind/NavigatorsLab-Receipt-OCR/github-pages?label=Pages&logo=github&event=push) ![Live check](https://img.shields.io/endpoint?url=https%3A%2F%2Fnavigatorslab.com%2Ftools%2Fbadge-ocr.json&cacheSeconds=300)

<h4 align="center">
  &#9654; <a href="https://navigatorslab.com/tools/ocr.html">Open it on navigatorslab.com</a> &mdash; free, no sign-up, nothing uploaded<br>
  <a href="https://navigatorslab.com/Receipt-OCR">navigatorslab.com/Receipt-OCR</a> &middot; same tool, shorter URL<br>
  This repo's Pages site runs the <em>actual tool</em>: <code>demo.html</code>
</h4>

![Receipt OCR → CSV banner](og.png)

Receipt photos to editable expenses: totals parsed on-device, categories, currency, confidence flags, CSV for Excel or Sheets.
...
1. Drop receipt photos
2. On-device OCR fills vendor, date and total rows
3. Export the CSV for your spreadsheet

## 📸 See it in action

![Receipt OCR → CSV in action](shot.png)
...
tesseract.js WASM engine, self-hosted same-origin — zero third-party requests
